...
# 💫 About Me:
Hi there! I'm Shivam! Former developer, Junior project manager at **JIO** & an aspiring **Data Analyst**📊<br>I'm currently learning Data Analysis using tools tools like **Excel**, **PowerBI**, **SQL** & **Python**.<br>I'm looking to collaborate on projects related to data domain.<br>Proficient in **Statistics**, **Power BI**, **Tableau** and **AI Enabled data analysis** are some of my other skills.<br>I'm always looking to learn new things and collaborate with others on this niche.<br>On Github, you'll find some of my work that showcase my skills.<br><br>Fun Fact: When there's a bug, there's hope for discovery!😉
...
<img width="48" height="48" src="https://img.icons8.com/fluency/48/microsoft-excel-2019.png" alt="microsoft-excel-2019"/><img width="48" height="48" src="https://img.icons8.com/color/48/power-bi.png" alt="power-bi"/>
<img width="48" height="48" src="https://img.icons8.com/external-bearicons-outline-color-bearicons/64/external-SQL-file-extension-bearicons-outline-color-bearicons.png" alt="external-SQL-file-extension-bearicons-outline-color-bearicons"/><img width="48" height="48" src="https://img.icons8.com/color/48/python--v1.png" alt="python--v1"/>
<img width="48" height="48" src="https://img.icons8.com/color/48/pandas.png" alt="pandas"/>
<img width="48" height="48" src="https://img.icons8.com/color/48/numpy.png" alt="numpy"/>
<img width="48" height="48" src="https://img.icons8.com/ios/50/tableau-software.png" alt="tableau-software"/><img width="48" height="48" src="https://img.icons8.com/fluency/48/statistics.png" alt="statistics"/>

**Dev Tools Used Earlier:**
